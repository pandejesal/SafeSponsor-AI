    ...
    <div className="min-h-screen bg-zinc-950 text-zinc-200">
      ...
      <main className="max-w-3xl mx-auto px-4 py-16 sm:py-24">
        ...
        <div className="space-y-6 text-zinc-400 text-sm leading-relaxed">
          ...
          <h2 className="text-lg font-semibold text-zinc-200 pt-4">4. Free Score Teaser</h2>
          <p>
          ...
          <h2 className="text-lg font-semibold text-zinc-200 pt-4">5. Payments</h2>
          <p>
          ...
          <h2 className="text-lg font-semibold text-zinc-200 pt-4">6. Refund Policy</h2>
          <p>
          ...
          <h2 className="text-lg font-semibold text-zinc-200 pt-4">7. Takedown Requests</h2>
          <p>
          ...
          <h2 className="text-lg font-semibold text-zinc-200 pt-4">8. Acceptable Use</h2>
          <p>
          ...
          <h2 className="text-lg font-semibold text-zinc-200 pt-4">9. Intellectual Property</h2>
          <p>
          ...
          <h2 className="text-lg font-semibold text-zinc-200 pt-4">10. Limitation of Liability</h2>
          <p>
          ...
          <h2 className="text-lg font-semibold text-zinc-200 pt-4">11. Termination</h2>
          <p>
            We reserve the right to terminate accounts that violate these terms. 
            You may delete your account at any time from the dashboard.
          </p>

          <h2 className="text-lg font-semibold text-zinc-200 pt-4">12. Contact</h2>
          <p>
